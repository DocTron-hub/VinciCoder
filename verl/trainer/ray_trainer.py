...
class ResourcePoolManager:
    ...
    # def get_num_gpus(self) -> int:
    #         """Get the total number of gpus allocated to the Global Pool workers."""
    #         global_pool_id = "global_pool_actors" 
            
    #         if global_pool_id not in self.resource_pool_spec:
    #             return 0
            
    #         global_pool_resources = self.resource_pool_spec[global_pool_id]
            
    #         total_gpus = 0
            
    #         for resource_spec in global_pool_resources:
    #             if isinstance(resource_spec, int):
    #                 total_gpus += resource_spec
                
    #             elif isinstance(resource_spec, dict):
    #                 N_GPUS_PER_NODE = 8 
    #                 total_gpus += N_GPUS_PER_NODE 
    ...
    def _check_resource_available(self):
        ...
        print(f"gpus_available: {gpus_available}")
...
class RayPPOTrainer:
    ...
    def _save_checkpoint(self) -> None:
        ...
        # print(f"dataloader_state_dict: {dataloader_state_dict}")
